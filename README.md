...
This project focuses on analyzing coffee shop sales data using Python for data cleaning and exploratory data analysis (EDA) and Power BI for interactive dashboard creation and business intelligence reporting. The objective of this project was to identify sales patterns, customer purchasing behavior, product performance, and store-level trends to support data-driven decision-making.
...
Data preprocessing was performed using Python libraries such as Pandas and NumPy to ensure data quality and consistency before analysis.
